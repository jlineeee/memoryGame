...
function shuffleCards() {
    ...
    let arr = ["fa-pepper-hot", "fa-apple-whole", "fa-ice-cream",
        "fa-carrot", "fa-hotdog", "fa-pizza-slice", "fa-pepper-hot", "fa-apple-whole", "fa-ice-cream",
        "fa-carrot", "fa-hotdog", "fa-pizza-slice"
    ]
    ...
    cards.forEach((card, index) => {
        ...
        setTimeout(() => {
            iconTag.classList.value = `fa-solid ${arr[index]}`;
        }, 500);
